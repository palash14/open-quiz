...
migrations: ## Run autogenerate migrations file
	$(DOCKER_COMPOSE) exec $(SERVICE_NAME) alembic revision --autogenerate -m "migrations"


migrate: ## Run database sync with migrations
